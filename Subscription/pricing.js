const currentHourPlan = document.getElementById("currentHourPlan");
const currentDailyPlan = document.getElementById("currentDailyPlan");
const currentWeeklyPlan = document.getElementById("currentWeeklyPlan");

if(!localStorage.getItem("choosenPlan")) {
    localStorage.setItem("hourly", 0);
    localStorage.setItem("daily", 0);
    localStorage.setItem("weekly", 0);
}else{
    localStorage.setItem("hourly", localStorage.getItem("hourly") || 0);
    localStorage.setItem("daily", localStorage.getItem("daily") || 0);
    localStorage.setItem("weekly", localStorage.getItem("weekly") || 0);
}
...
function hourPurchase() {
    localStorage.setItem("hourly", 1);
    localStorage.setItem("daily", 0);
    localStorage.setItem("weekly", 0);
    window.location.href = "purchase.html";
}
function dayPurchase() {
    localStorage.setItem("hourly", 0);
    localStorage.setItem("daily", 1);
    localStorage.setItem("weekly", 0);
    window.location.href = "purchase.html";
}
function weekPurchase() {
    localStorage.setItem("hourly", 0);
    localStorage.setItem("daily", 0);
    localStorage.setItem("weekly", 1);
    window.location.href = "purchase.html";
}

if(localStorage.getItem("hourly") == 1) {
    currentHourPlan.classList.add('show');
}else if(localStorage.getItem("daily") == 1) {
    currentDailyPlan.classList.add('show');
}else if(localStorage.getItem("weekly") == 1) {
    currentWeeklyPlan.classList.add('show');
}else{
